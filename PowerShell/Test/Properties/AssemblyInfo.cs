...
[assembly: AssemblyDescription("Unit tests for a PowerShell module to make the Project Gutenberg " +
                               "catalog browsable same way as you work with the local file system.")]
