...
namespace GutenPosh
{
                         ...
                         IComparable<Date>, IEquatable<Date>, IXmlSerializable
    {
        ...
        bool IConvertible.ToBoolean(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.Boolean.");
        }

        byte IConvertible.ToByte(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.Byte.");
        }

        char IConvertible.ToChar(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.Char.");
        }
        ...
        decimal IConvertible.ToDecimal(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.Decimal.");
        }
        ...
        short IConvertible.ToInt16(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.Int16.");
        }

        int IConvertible.ToInt32(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.Int32.");
        }

        long IConvertible.ToInt64(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.Int64.");
        }

        sbyte IConvertible.ToSByte(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.SByte.");
        }

        float IConvertible.ToSingle(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.Single.");
        }
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider) {
            ...
            if (conversionType == typeof(DateTime))
                return time;
            throw new InvalidCastException(string.Format("Cannot convert GutenPosh.Date to {0}.",
                                                         conversionType));
        }

        ushort IConvertible.ToUInt16(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.UInt16.");
        }

        uint IConvertible.ToUInt32(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.UInt32.");
        }

        ulong IConvertible.ToUInt64(IFormatProvider provider) {
            throw new InvalidCastException("Cannot convert GutenPosh.Date to System.UInt64.");
        }
