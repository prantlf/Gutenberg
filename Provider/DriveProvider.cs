        ...
        IPropertyCmdletProvider
    {
        ...
        protected override PSDriveInfo NewDrive(PSDriveInfo drive) {
            ...
            if (!newDrive.Cache.HasLibrary())
                WriteWarning("There is no catalogue available. Before accessing the Gutenberg " +
                    "drive create the local catalogue copy by the Update-GPCatalogue command.");
            return newDrive;
        }
        ...
        protected override ProviderInfo Start(ProviderInfo providerInfo) {
            ...
            if (string.IsNullOrEmpty(providerInfo.Description))
                providerInfo.Description = "Browses the Gutenberg project catalogue " +
        ...
        protected override void InvokeDefaultAction(string path) {
            ...
            Process.Start(PathUtility.JoinPath(Catalogue.ProjectUrl, "ebooks",
